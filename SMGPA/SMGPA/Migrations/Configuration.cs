namespace SMGPA.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SMGPA.Models.SMGPAContext>
    {
        ...
        protected override void Seed(SMGPA.Models.SMGPAContext context)
        {
            ...
            //Permission p46 = new Permission { TextLink = "Remover Carrera de Facultad", Controller = "Entities", ActionResult = "RemoveCareer", ActiveMenu = false };
            ...
            //permisos.Add(p41); permisos.Add(p42); permisos.Add(p43); permisos.Add(p44); permisos.Add(p45); permisos.Add(p46);
